        ...
        <div className="bg-white">
                    ...
                    <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
                        ...
                        <div className="mt-8 sm:flex">
                            ...
                            <a
                                href="#"
                                className="flex items-center justify-center rounded-md border border-transparent bg-blue-100 px-5 py-3 text-base font-medium text-blue-700 hover:bg-blue-200"
                            >
                                Contact Us
                            </a>
                            </div>
