export default function Header() {
    return (
      <div className="relative overflow-hidden bg-white">
        <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-24 lg:pb-48">
          <div className="relative mx-auto max-w-full px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-3xl">
              <h1 className="mt-20 font text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Careers at AppCraft
              </h1>
              <p className="mt-20 text-2xl leading-10 max-w-2xl text-gray-900">
